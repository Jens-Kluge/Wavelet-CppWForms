...
namespace RefEditControl
{
	...
	/// </summary>
	public enum class ReferenceStyle /* enum 'class' need for property window */
	{
		/// <summary>
...
/// <summary>
/// The display style to use when the control is collapsed
/// </summary>
	public enum class CollapseStyle
	{
		/// <summary>
		/// No Change
		/// </summary>
...
/// </summary>
public enum class ResultSeparator
{
	/// <summary>
	/// No separator
	/// </summary>
